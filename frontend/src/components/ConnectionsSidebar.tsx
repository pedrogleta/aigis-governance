      ...
      >
        ...
        <div className="space-y-2 mb-6">
          ...
          {formState.db_type === 'sqlite' ? (
            ...
            <>
              <label className="block text-sm text-gray-300 mt-3">Host</label>
              <input
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2"
                value={formState.host || ''}
                onChange={(e) =>
              ...
              />
              <label className="block text-sm text-gray-300 mt-3">Port</label>
              <input
                type="number"
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2"
                value={formState.port || ''}
                onChange={(e) =>
                  setFormState({ ...formState, port: Number(e.target.value) })
                }
                placeholder="5432"
              />
              <label className="block text-sm text-gray-300 mt-3">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormState({ ...formState, database_name: e.target.value })
                }
            ...
            {connections.map((c) => (
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <button
                    title={
                      selectedConnection?.id === c.id ? 'Selected' : 'Select'
                    }
                    onClick={() => onSelect(c)}
                    className={cn(
